<%@ Page Language="C#" AutoEventWireup="true" CodeFile="money.aspx.cs" Inherits="manage_money" %>
				...
				<div id="sidebar" class="sidebar sidebar-fixed">
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="active"><a><i class="fa fa-desktop fa-fw"></i> <span class="menu-text">查看经费</span></a></li>
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12" style="min-height:300px">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="box border orange">
                                    <div class="box-title">
                                        <h4 style="font-family:微软雅黑"><i class="fa fa-hand-o-up"></i>经费使用情况统计图</h4>
                                        <div class="tools">
                                    ...
                                    <div class="box-body" style="font-family:微软雅黑;min-height:450px">
                                        <div class="form-group">
                                            <div class="col-md-6" style="text-align:center">
                                                <asp:Chart ID="Chart1"  runat="server" Width="500px" Height="400px" BorderDashStyle="Solid" Palette="BrightPastel" imagetype="Png"  BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" backcolor=Gray  BorderColor="26, 59, 105">
                                                <Series>
                                                <asp:Series Name="Series1">
                                                </asp:Series>
                                            </Series>
                                            <Titles>
                                        <asp:Title Font="微软雅黑, 16pt" Name="Title1" Text="项目经费使用情况">
                                        </asp:Title>
                                        </Titles>
                                        <Legends><asp:Legend BackColor=Transparent  Font="微软雅黑,10pt"></asp:Legend></Legends>
                                        <borderskin skinstyle="Emboss"></borderskin>
                                            <ChartAreas>
                                                <asp:ChartArea Area3DStyle-Enable3D=true Name="ChartArea1" BorderColor="64, 64, 64, 64" BackSecondaryColor="Transparent" BackColor="0, 165, 191, 228" ShadowColor="Transparent" BackGradientStyle="TopBottom">
                                                </asp:ChartArea>
                                            </ChartAreas>
                                            </asp:Chart>
                                            </div>
                                            <div class="col-md-6" style="text-align:center">
                                                <asp:Chart ID="Chart2"  runat="server" Width="500px" Height="400px" BorderDashStyle="Solid" Palette="BrightPastel" imagetype="Png"  BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" backcolor=LightBlue BorderColor="26, 59, 105">
                                                    <Series>
                                                        <asp:Series Name="Series1">
                                                        </asp:Series>
                                                    </Series>
                                                    <Titles>
                                                <asp:Title Font="微软雅黑, 16pt" Name="Title1" Text="本人经费使用情况">
                                                </asp:Title>
                                                </Titles>
                                                <Legends><asp:Legend BackColor=Transparent  Font="微软雅黑,10pt"></asp:Legend></Legends>
                                                <borderskin skinstyle="Emboss"></borderskin>
                                                    <ChartAreas>
                                                        <asp:ChartArea Area3DStyle-Enable3D=true Name="ChartArea1" BorderColor="64, 64, 64, 64" BackSecondaryColor="Transparent" BackColor="0, 246, 246, 228" ShadowColor="Transparent" BackGradientStyle="TopBottom">
                                                        </asp:ChartArea>
                                                    </ChartAreas>
                                                </asp:Chart>
                                            </div>
                        ...
                        <!--会议论文栏目-->
                        <div id="mx" class="row" style="font-family:微软雅黑">
                            <div class="col-md-12">
                                <!-- BOX -->
                                <div class="box border green">
                                    <div class="box-title">
                                        <h4 style="font-family:微软雅黑"><i class="fa fa-bookmark-o"></i>经费明细查询</h4>
                                        <div class="tools">
                                            <a href="#box-config" data-toggle="modal" class="config">
                                                <i class="fa fa-cog"></i>
                                            </a>
                                    ...
                                    <div class="box-body" style="font-family:微软雅黑">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-sm-8"><asp:TextBox ID="chaxuntitle" runat="server" CssClass="form-control" placeholder="请输入所要查询的信息"></asp:TextBox></div>
                                            <div class="col-sm-4"><asp:Button ID="chaxunyes" runat="server" CssClass="btn btn-primary" Text="查询" OnClick="chaxunyes_Click" /></div>
                                        </div>
                                        <div class="col-md-3"></div>
                                        <table class="table table-hover" style="font-family:微软雅黑;margin-top:50px">
                                            <thead>
                                                <tr>
                                                    <th>-</th>
                                                    <th>姓名</th>
