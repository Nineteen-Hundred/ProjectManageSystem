...
public partial class manage_delete : System.Web.UI.Page
{
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "DELETE files WHERE projectno='" + Session["xiangmuhao"].ToString() + "' and filename='" + Request.QueryString["path"].ToString()
                + "' and info ='" + Request.QueryString["info"].ToString() + "'";
